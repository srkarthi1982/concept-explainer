...
## Scope
- Mini-app repository for 'concept-explainer' within Ansiversa.
...
## Task Log (Recent)
- 2026-04-08 Rolled out Landing Page Standard V1.1: replaced the minimal landing with the approved Ansiversa product-storytelling landing, kept concept-library truth aligned to app-spec/freeze behavior, and revalidated `npm run typecheck`, `npm run build`, and `/` CTA behavior.
